...
|---|---|---|
| `ts/` | @voxgig-sdk/domain-whois-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/domain-whois-sdk \
      --repository voxgig-sdk/domain-whois-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/domain-whois-sdk` shows it, and
`npm trust revoke @voxgig-sdk/domain-whois-sdk --id=<id>` removes it.

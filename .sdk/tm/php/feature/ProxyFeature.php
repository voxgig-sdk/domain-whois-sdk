...
class DomainWhoisProxyFeature extends DomainWhoisBaseFeature
{
    ...
    public function init(DomainWhoisContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DomainWhoisContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

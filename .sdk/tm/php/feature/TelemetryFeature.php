...
// DomainWhois SDK telemetry feature
...
class DomainWhoisTelemetryFeature extends DomainWhoisBaseFeature
{
    ...
    private function _close(DomainWhoisContext $ctx, bool $ok): void
    {

...
// DomainWhois SDK ratelimit feature
...
class DomainWhoisRatelimitFeature extends DomainWhoisBaseFeature
{
    ...
    private function _acquire(DomainWhoisContext $ctx): void
    {
    ...
    private function _track(DomainWhoisContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

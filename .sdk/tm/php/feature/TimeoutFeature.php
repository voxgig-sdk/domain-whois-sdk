...
// DomainWhois SDK timeout feature
...
class DomainWhoisTimeoutFeature extends DomainWhoisBaseFeature
{
    ...
    private function _with_timeout(DomainWhoisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DomainWhoisContext $_ctx, float $ms): void
    {
        $client = $this->client;

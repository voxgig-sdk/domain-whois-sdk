...
// DomainWhois SDK metrics feature
...
class DomainWhoisMetricsFeature extends DomainWhoisBaseFeature
{
    ...
    private function _record(DomainWhoisContext $ctx, bool $ok): void
    {

...
// DomainWhois SDK clienttrack feature
...
class DomainWhoisClienttrackFeature extends DomainWhoisBaseFeature
{
    ...
    public function PostConstruct(DomainWhoisContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DomainWhois-SDK';

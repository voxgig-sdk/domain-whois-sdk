...
class DomainWhoisCacheFeature extends DomainWhoisBaseFeature
{
    ...
    private function _through(DomainWhoisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

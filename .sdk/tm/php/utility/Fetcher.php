...
// DomainWhois SDK utility: fetcher

class DomainWhoisFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DomainWhoisSDK/1.0)';
    ...
    public static function call(DomainWhoisContext $ctx, string $fullurl, array $fetchdef): array
    {

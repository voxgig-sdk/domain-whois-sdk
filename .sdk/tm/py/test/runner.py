...
class DomainWhoisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DomainWhoisTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DomainWhoisTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DomainWhoisTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

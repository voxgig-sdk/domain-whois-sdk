...
class DomainWhoisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DomainWhoisTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DomainWhoisTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DomainWhoisTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

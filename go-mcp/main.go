// Command DomainWhois-mcp is an MCP server exposing the DomainWhois
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DomainWhois_list  — list records of an entity
//	DomainWhois_load  — load a single record of an entity
//

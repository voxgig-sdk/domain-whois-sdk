...
func registerTools(server *mcp.Server, client *sdk.DomainWhoisSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "domain-whois_list",
		Description: "List records from DomainWhois. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "domain-whois_load",
		Description: "Load a single record from DomainWhois. " +
...
func runOp(client *sdk.DomainWhoisSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DomainWhoisSDK, name string) (sdk.DomainWhoisEntity, error) {

...
func registerSDKWords(r *eng.Registry, client *sdk.DomainWhoisSDK) {
...
func runOp(client *sdk.DomainWhoisSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

...
(0, node_test_1.describe)('WhoiEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set DOMAIN_WHOIS_TEST_WHOI_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['DOMAIN_WHOIS_TEST_WHOI_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'DOMAIN_WHOIS_TEST_WHOI_ENTID': idmap,
        'DOMAIN_WHOIS_TEST_LIVE': 'FALSE',
        'DOMAIN_WHOIS_TEST_EXPLAIN': 'FALSE',
        'DOMAIN_WHOIS_APIKEY': '',
    });
    idmap = env['DOMAIN_WHOIS_TEST_WHOI_ENTID'];

...
(0, node_test_1.describe)('EmailValidateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DomainWhoisSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DomainWhoisSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.DOMAIN_WHOIS_APIKEY,
        }));
        let idmap = env['DOMAIN_WHOIS_TEST_EMAIL_VALIDATE_ENTID'];
    ...
    const client = new __1.DomainWhoisSDK({
        base: 'http://localhost:8080',

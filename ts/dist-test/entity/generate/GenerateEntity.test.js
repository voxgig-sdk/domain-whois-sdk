...
(0, node_test_1.describe)('GenerateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set DOMAIN_WHOIS_TEST_GENERATE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['DOMAIN_WHOIS_TEST_GENERATE_ENTID'];
    ...
    idmap = env['DOMAIN_WHOIS_TEST_GENERATE_ENTID'];

...
function envOverride(m) {
    if ('TRUE' === process.env.DOMAIN_WHOIS_TEST_LIVE ||
        'TRUE' === process.env.DOMAIN_WHOIS_TEST_OVERRIDE) {
    ...
    m.DOMAIN_WHOIS_TEST_EXPLAIN = process.env.DOMAIN_WHOIS_TEST_EXPLAIN || m.DOMAIN_WHOIS_TEST_EXPLAIN;
    return m;
}

...
declare class DomainWhoisSDK {
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): DomainWhoisSDK;
    tester(testopts?: any, sdkopts?: any): DomainWhoisSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof DomainWhoisSDK;
export { stdutil, config, BaseFeature, DomainWhoisEntityBase, DomainWhoisSDK, SDK, };

# DomainWhois Golang SDK Reference

Complete API reference for the DomainWhois Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *DomainWhoisSDK`

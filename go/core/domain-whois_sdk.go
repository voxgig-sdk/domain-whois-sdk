...
import (
	...
	vs "github.com/voxgig-sdk/domain-whois-sdk/go/utility/struct"
)

type DomainWhoisSDK struct {
	Mode     string
...
func (sdk *DomainWhoisSDK) OptionsMap() map[string]any {
...
func (sdk *DomainWhoisSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DomainWhoisSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DomainWhoisSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DomainWhoisSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DomainWhoisSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DomainWhoisSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DomainWhoisSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DomainWhoisSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DomainWhoisSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DomainWhoisSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *DomainWhoisSDK) DnsResult(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Domain(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) EmailValidate(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Generate(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Grammar(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Ipn(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Redact(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Ssl(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Utility(data map[string]any) DomainWhoisEntity {
...
func (sdk *DomainWhoisSDK) Whoi(data map[string]any) DomainWhoisEntity {

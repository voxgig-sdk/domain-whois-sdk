...
class GrammarEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DOMAIN_WHOIS_TEST_GRAMMAR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function grammar_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DOMAIN_WHOIS_TEST_GRAMMAR_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["DOMAIN_WHOIS_TEST_GRAMMAR_ENTID"]);

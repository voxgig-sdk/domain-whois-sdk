...
// DomainWhois SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DomainWhoisOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DomainWhoisOmni::structfix($now, Struct::undef()))
                        !== json_encode(DomainWhoisOmni::structfix($val, Struct::undef()))) {

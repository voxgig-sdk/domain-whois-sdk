...
// DomainWhois SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DomainWhoisSDK::test)
...
{
    private const SDK_CLASS = 'DomainWhoisSDK';
    ...
    private const SDK_BASE = 'domainwhois_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../domainwhois_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

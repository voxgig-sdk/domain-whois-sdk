...
The PHP SDK for the DomainWhois API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'domainwhois_sdk.php';

$client = new DomainWhoisSDK([
    "apikey" => getenv("DOMAIN_WHOIS_APIKEY"),
]);
```
...
```php
require_once 'domainwhois_sdk.php';
$client = new DomainWhoisSDK($options);
```
...
```
php/
├── domainwhois_sdk.php          -- Main SDK class
...
The main class (`domainwhois_sdk.php`) exports the SDK class

# DomainWhois PHP SDK Reference

Complete API reference for the DomainWhois PHP SDK.
...
#### `DomainWhoisSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): DomainWhoisUtility`

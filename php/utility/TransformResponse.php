...
// DomainWhois SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DomainWhoisTransformResponse
{
    public static function call(DomainWhoisContext $ctx): mixed
    {
        ...
        $transform = DomainWhoisHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

...
// DomainWhois SDK utility: graphql
//
...
class DomainWhoisGraphql
{
    ...
    // equivalent.
    public static function body(DomainWhoisContext $ctx): mixed
    {
    ...
    public static function errors(DomainWhoisContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

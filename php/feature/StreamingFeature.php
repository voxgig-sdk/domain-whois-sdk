...
// DomainWhois SDK streaming feature
...
class DomainWhoisStreamingFeature extends DomainWhoisBaseFeature
{
    ...
    private function _iterate(DomainWhoisResult $result): \Generator
    {
    ...
    private function _streamable(DomainWhoisContext $ctx): bool
    {

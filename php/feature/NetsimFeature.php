...
// DomainWhois SDK netsim feature
...
class DomainWhoisNetsimFeature extends DomainWhoisBaseFeature
{
    ...
    private function _simulate(DomainWhoisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DomainWhoisContext $ctx, array $applied): void
    {
        $client = $this->client;

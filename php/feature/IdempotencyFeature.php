...
// DomainWhois SDK idempotency feature
...
class DomainWhoisIdempotencyFeature extends DomainWhoisBaseFeature
{
    ...
    private function _mutating(DomainWhoisContext $ctx): bool
    {

...
// DomainWhois SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DomainWhoisTestFeature extends DomainWhoisBaseFeature
{
    ...
    public function init(DomainWhoisContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DomainWhoisContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DomainWhoisParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DomainWhoisContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DomainWhoisContext $ctx, $op, $args): array
    {

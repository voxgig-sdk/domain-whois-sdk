...
class DomainWhoisRbacFeature extends DomainWhoisBaseFeature
{
    ...
    private function _required(DomainWhoisContext $ctx): ?string
    {
    ...
    private function _reject(DomainWhoisContext $ctx, string $required): void
    {
    ...
    private function _track(DomainWhoisContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

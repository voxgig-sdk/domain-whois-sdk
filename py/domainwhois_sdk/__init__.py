...
from domainwhois_sdk.utility import register

# Load features
from domainwhois_sdk.feature.base_feature import DomainWhoisBaseFeature
from domainwhois_sdk.features import _has_feature, _make_feature


class DomainWhoisSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DomainWhoisUtility()
        self._utility = utility

        from domainwhois_sdk.config import shared_config
    ...
    def get_utility(self):
        return DomainWhoisUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "DomainWhoisSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DomainWhoisSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DnsResult(self, data=None) -> "DnsResultEntity":
        ...
        from domainwhois_sdk.entity.dns_result_entity import DnsResultEntity
    ...
    def Domain(self, data=None) -> "DomainEntity":
        ...
        from domainwhois_sdk.entity.domain_entity import DomainEntity
    ...
    def EmailValidate(self, data=None) -> "EmailValidateEntity":
        ...
        from domainwhois_sdk.entity.email_validate_entity import EmailValidateEntity
    ...
    def Generate(self, data=None) -> "GenerateEntity":
        ...
        from domainwhois_sdk.entity.generate_entity import GenerateEntity
    ...
    def Utility(self, data=None) -> "UtilityEntity":
        ...
        from domainwhois_sdk.entity.utility_entity import UtilityEntity
        return UtilityEntity(self, data)


    def Whoi(self, data=None) -> "WhoiEntity":
        """Entity factory: client.Whoi().list() / client.Whoi().load({"id": ...})."""
        from domainwhois_sdk.entity.whoi_entity import WhoiEntity
        return WhoiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "DomainWhoisSDK":
        if sdkopts is None:
            sdkopts = {}

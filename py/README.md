# DomainWhois Python SDK



The Python SDK for the DomainWhois API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/domain-whois-sdk/releases)) or
...
client = DomainWhoisSDK({
    "apikey": os.environ.get("DOMAIN_WHOIS_APIKEY"),
})
```
...
```
py/
├── domainwhois_sdk.py         -- Main SDK module

# DomainWhois SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DomainWhoisSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DomainWhoisSDK(...) and DomainWhoisSDK.test(...) become
#      DomainWhoisSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "domainwhois_sdk"
_SDK_CLASS = "DomainWhoisSDK"

...
local DomainWhoisSDK = {}
DomainWhoisSDK.__index = DomainWhoisSDK
...
DomainWhoisSDK._make_feature = _make_feature


function DomainWhoisSDK.new(options)
  local self = setmetatable({}, DomainWhoisSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DomainWhoisSDK:options_map()
...
function DomainWhoisSDK:get_utility()
  return Utility.copy(self._utility)
end


function DomainWhoisSDK:get_root_ctx()
  return self._rootctx
end


function DomainWhoisSDK:prepare(fetchargs)
...
function DomainWhoisSDK:direct(fetchargs)
...
-- by passing it.
function DomainWhoisSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DomainWhoisSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "DomainWhoisSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function DomainWhoisSDK:DnsResult(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Domain(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:EmailValidate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Generate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Grammar(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Ipn(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Redact(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Ssl(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Utility(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function DomainWhoisSDK:Whoi(data)
...
function DomainWhoisSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DomainWhoisSDK.new(sdkopts)
  sdk.mode = "test"

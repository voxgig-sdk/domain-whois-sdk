...
describe("IpnEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DOMAINWHOIS_TEST_IPN_ENTID JSON to run live")
      return
    end
...
function ipn_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DOMAINWHOIS_TEST_IPN_ENTID")

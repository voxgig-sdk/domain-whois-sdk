...
describe("SslEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DOMAINWHOIS_TEST_SSL_ENTID JSON to run live")
      return
    end
...
function ssl_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DOMAINWHOIS_TEST_SSL_ENTID")

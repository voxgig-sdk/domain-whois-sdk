...
function runner.env_override(m)
  local live = runner.getenv("DOMAIN_WHOIS_TEST_LIVE")
  local override = runner.getenv("DOMAIN_WHOIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DOMAIN_WHOIS_TEST_EXPLAIN")

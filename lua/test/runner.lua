...
function runner.env_override(m)
  local live = runner.getenv("DOMAINWHOIS_TEST_LIVE")
  local override = runner.getenv("DOMAINWHOIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DOMAINWHOIS_TEST_EXPLAIN")

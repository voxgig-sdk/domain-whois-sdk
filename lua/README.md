...
The Lua SDK for the DomainWhois API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/domain-whois-sdk/releases)),
...
```
lua/
├── domain-whois_sdk.lua    -- Main SDK module
...
The main module (`domain-whois_sdk`) exports the SDK constructor
